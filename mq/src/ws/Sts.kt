...
private val simpleHttpClient: HttpClient = ktor.createClient(LogLevel.ALL, null, null, null)

class StsClient(
    private val config: StsConfig,
    private val http: HttpClient = simpleHttpClient,
    private val jackson: ObjectMapper = jacksonObjectMapper(),
    private val cache: TokenCache<String, SamlToken> = TokenCache(),
